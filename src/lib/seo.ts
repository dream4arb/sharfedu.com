...
export const DEFAULT_SEO = {
  title: "منصة شارف التعليمية - Sharaf | تعلم تفاعلي عربي",
  description:
    "شارف منصة تعليمية عربية للمنهج السعودي، تبني تجربة تجمع الشرح التفاعلي والتمارين والمعلم الافتراضي وتتبع إتقان المهارات.",
  keywords: "شارف, منصة تعليمية عربية, دروس تفاعلية, تعليم ذكي, السعودية, رياضيات",
} as const;
